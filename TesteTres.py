...
menor_faturamento = min(faturamento_validos) if faturamento_validos else 0
maior_faturamento = max(faturamento_validos) if faturamento_validos else 0
media_mensal = sum(faturamento_validos) / len(faturamento_validos) if faturamento_validos else 0
